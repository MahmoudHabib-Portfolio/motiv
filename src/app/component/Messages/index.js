          ...
          <div className='flex flex-col gap-y-3'>
            ...
            <div className='flex flex-col gap-y-3 overflow-y-auto w-full msgBox' style={{height:"100vh"}}>
              ...
              <div className='flex flex-col gap-y-3 w-full'>
                ...
                onClick={() => {setSelectedMember(x); setValue(x.id)}}>
                  <List>
                    <ListItem sx={{padding:"0px"}}>
                      <ListItemIcon sx={{minWidth:"65px"}}>
                        <Avatar src={`/imgs/${x.img}`} sx={{width:"50px", height:"50px"}} />
              ...
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"Killan-James.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
            ...
            <TabPanel value={value} index={1}>
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"Desian-Tam.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
                    <div className="bg-chipBg p-2 rounded-lg text-white text-left font-dmsansReg text-sm w-full">
                          Hi, I hope you are doing well, yesterday you have gave a pen This very nice, i am very happy for this.yesterday you have gave a pen This very nice
                        </div>
            ...
            <TabPanel value={value} index={2}>
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"AhmedMedi.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
                    <div className="bg-chipBg p-2 rounded-lg text-white text-left font-dmsansReg text-sm w-full">
                          Hi, I hope you are doing well, yesterday you have gave a pen This very nice, i am very happy for this.yesterday you have gave a pen This very nice
                        </div>
            ...
            <TabPanel value={value} index={3}>
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"ClaudiaMaudi.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
                    <div className="bg-chipBg p-2 rounded-lg text-white text-left font-dmsansReg text-sm w-full">
                          Hi, I hope you are doing well, yesterday you have gave a pen This very nice, i am very happy for this.yesterday you have gave a pen This very nice
                        </div>
            ...
            <TabPanel value={value} index={4}>
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"MilieNose.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
                    <div className="bg-chipBg p-2 rounded-lg text-white text-left font-dmsansReg text-sm w-full">
                          Hi, I hope you are doing well, yesterday you have gave a pen This very nice, i am very happy for this.yesterday you have gave a pen This very nice
                        </div>
            ...
            <TabPanel value={value} index={5}>
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"IkhsanSD.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
                    <div className="bg-chipBg p-2 rounded-lg text-white text-left font-dmsansReg text-sm w-full">
                          Hi, I hope you are doing well, yesterday you have gave a pen This very nice, i am very happy for this.yesterday you have gave a pen This very nice
                        </div>
            ...
            <TabPanel value={value} index={6}>
              <div className="flex flex-col gap-y-9 px-3 overflow-x-auto msgBox" style={{height:"100vh"}}>
                ...
                <div className='flex flex-col gap-y-1 w-full'>
                  <div className="flex flex-row gap-x-3 w-full">
                    <div>
                      <Avatar src={`/imgs/${"Aditya.png"}`} sx={{width:"50px", height:"50px"}} />
                    </div>
                    <div className="bg-chipBg p-2 rounded-lg text-white text-left font-dmsansReg text-sm w-full">
                          Hi, I hope you are doing well, yesterday you have gave a pen This very nice, i am very happy for this.yesterday you have gave a pen This very nice
                        </div>
