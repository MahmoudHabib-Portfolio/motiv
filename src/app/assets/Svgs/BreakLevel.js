...
const BreakLevel = (props) => {
  ...
  >
    ...
    strokeWidth={12}
    />
    <text id="text3" x={35} y={65} fontWeight={"600"} fontSize={"22px"} fill="#fff"></text>
    </motion.svg>
  )
}
