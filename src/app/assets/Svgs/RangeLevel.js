...
const RangeLevel = (props) => {
  ...
  >
    ...
    strokeWidth={12}
    />
    <text id="text2" x={35} y={65} fontWeight={"600"} fontSize={"22px"} fill="#fff"></text>
 </svg>
  )
}
